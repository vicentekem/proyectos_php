...
function addProductToCard(id_product){
    ...
    productsStorageString = localStorage.getItem('products') || '[]';
    productsStorage = JSON.parse( productsStorageString );
    console.log( productsStorage );

    if( productsStorage.find( el => el.id == id_product ) == undefined ){
        productsStorage.push( productSelected );
